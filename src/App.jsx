        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/donor" element={<DonorLayout />}>
              ...
              <Route path="history" element={<div className="p-12 text-center text-slate-400 font-bold">Donation History</div>} />
              <Route path="requests" element={<div className="p-12 text-center text-slate-400 font-bold">Nearby Requests</div>} />
            </Route>
