...
const BloodPill = ({ type, units }) => {
    ...
    return (
        <div className={`${s.bg} rounded-xl px-3 py-2 flex flex-col items-center min-w-[52px]`}>
            <span className={`font-bold text-sm ${s.text}`}>{type}</span>
        ...
        >
            <div className="flex items-start justify-between mb-4">
                <div className="flex items-center space-x-3">
                    ...
                    <div>
                        <h3 className="font-bold text-slate-800 text-lg leading-tight tracking-tight">{hospital.name}</h3>
                ...
                <span className={`text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-[0.2em] border ${isLimited ? 'bg-amber-50 text-amber-600 border-amber-100' : 'bg-emerald-50 text-emerald-600 border-emerald-100'}`}>
            ...
            <div>
                <div className="flex items-center space-x-2 mb-3">
                    ...
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Medical Inventory Overview</p>
                </div>
    ...
    return (
        <div className="min-h-screen bg-slate-50 font-inter">
            ...
            <div className="relative bg-gradient-to-br from-slate-900 to-slate-800 text-white overflow-hidden">
                ...
                <div className="relative max-w-6xl mx-auto px-6 py-20 text-center">
                    <div className="transition-all duration-1000" style={{
                        ...
                        <div className="inline-flex items-center px-4 py-1.5 bg-white/10 rounded-full text-[10px] font-bold uppercase tracking-[0.3em] mb-8 border border-white/10">
                            Network Directory
                        </div>
                    ...
                    <div className="flex items-center space-x-2 flex-wrap gap-2">
                        ...
                        {BLOOD_TYPES.map(bt => (
                            <button
                                ...
                                className={`px-4 py-2 rounded-xl text-xs font-bold uppercase tracking-wider transition-all ${bloodFilter === bt ? 'bg-primary text-white shadow-lg shadow-primary/20' : 'bg-slate-100 text-slate-500 hover:bg-slate-200'}`}
                            >
                                {bt}
                            </button>
                        ))}
            ...
            <div className="max-w-6xl mx-auto px-6 pb-20">
                <div className="bg-gradient-to-br from-primary to-red-800 rounded-3xl p-12 text-white text-center shadow-2xl shadow-primary/20">
                    <Heart size={44} className="mx-auto mb-6 text-white/80" />
                    <h2 className="text-5xl font-bold tracking-tight mb-6">Is Your Hospital Listed?</h2>
                    <p className="text-red-100 max-w-xl mx-auto text-lg mb-10 font-medium">
                        Join the fastest growing life-saving network in the region and digitize your blood bank management today.
                    </p>
                    <div className="flex justify-center">
                        <Link to="/hospital/register">
                            <button className="bg-white text-primary font-bold px-10 py-5 rounded-2xl hover:bg-red-50 transition-all shadow-2xl hover:scale-105 text-sm uppercase tracking-[0.2em]">
                                Register Facility
                            </button>
                        </Link>
                    </div>
