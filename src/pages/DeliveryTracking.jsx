            ...
            <div className="flex-1 bg-slate-100">
                ...
                <div className="absolute top-6 left-6 right-6 flex flex-col sm:row justify-between items-start gap-4">
                    ...
                    <div className="bg-white p-4 rounded-2xl shadow-xl border border-slate-100 flex items-center space-x-4">
                        ...
                        <div>
                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] leading-none">Status</p>
                            <p className="text-lg font-bold text-slate-800 mt-2">Active Dispatch</p>
                        </div>
                        <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100/50">
                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] leading-none">E.T.A</p>
                            <p className="text-lg font-bold text-secondary mt-2">4.2 MIN</p>
                        </div>
                    </div>
                </div>
