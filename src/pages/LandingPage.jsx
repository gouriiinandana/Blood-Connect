        ...
        <div className="space-y-24 pb-24 relative overflow-hidden">
            ...
            <section className="relative pt-20 px-6 sm:px-12 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-8 relative z-10">
                    ...
                    <div className="flex items-center space-x-8 pt-4">
                        ...
                        <p className="text-sm text-slate-500 font-bold uppercase tracking-wider">
                            Joined by <span className="text-slate-900 font-black">12,000+</span> active donors
                        </p>
                    </div>
                </div>
                ...
                <div className="relative z-10">
                    ...
                    <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-2xl relative overflow-hidden group">
                        <div className="absolute top-0 right-0 p-8 text-primary/10 group-hover:text-primary/20 transition-colors">
                            <Activity size={120} />
                        </div>
                        <div className="relative z-10 space-y-6">
                            <div className="flex items-center justify-between">
                                <h3 className="font-black text-slate-800 italic uppercase tracking-tighter text-xl">Live AI Matching</h3>
                    ...
                    {/* Floating element */}
                    <div className="absolute -bottom-16 -right-4 lg:-right-10 bg-white p-4 rounded-2xl shadow-xl border border-slate-100 flex items-center space-x-3 animate-bounce z-20">
                        ...
                        <div>
                            <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">New Match</p>
                            <p className="text-sm font-black text-slate-800">O- Negative Found</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="inventory" className="py-24 px-6 sm:px-12 bg-slate-50 relative z-10">
                <div className="max-w-7xl mx-auto space-y-16">
                    <div className="text-center space-y-4">
                        <div className="inline-flex items-center px-4 py-1.5 bg-secondary/5 text-secondary rounded-full text-[10px] font-black uppercase tracking-[0.2em] border border-secondary/10">
                            Regional Command Center
                        </div>
                        <h2 className="text-4xl sm:text-5xl font-black text-slate-800 italic tracking-tight">Real-Time Blood Availability</h2>
            ...
            {/* How It Works */}
            <section id="how-it-works" className="py-24 px-6 sm:px-12 max-w-7xl mx-auto relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    {[
                        ...
                        <div key={i} className="relative group p-10 rounded-[2.5rem] bg-white border border-slate-50 shadow-xl shadow-slate-100/50 hover:border-primary/20 transition-all">
                            <div className="w-20 h-20 bg-slate-50 border border-slate-100 rounded-3xl flex items-center justify-center mb-10 shadow-sm group-hover:scale-110 group-hover:bg-primary group-hover:text-white transition-all">
                                <step.icon size={36} />
                            </div>
                            <h3 className="text-3xl font-black text-slate-800 mb-4 italic tracking-tight">{step.title}</h3>
                            <p className="text-slate-500 font-medium leading-relaxed">{step.desc}</p>
                            <div className="absolute top-10 right-10 text-8xl font-black text-slate-50 -z-10 group-hover:text-primary/5 transition-colors">0{i + 1}</div>
                        </div>
                    ))}
                </div>
            </section>
            ...
            {/* Trust Quote / Stats */}
            <section className="bg-secondary p-12 sm:p-24 mx-6 sm:mx-12 rounded-[4rem] text-white relative z-10 shadow-2xl shadow-secondary/20 border-4 border-white/10">
                <div className="max-w-4xl mx-auto text-center space-y-16">
                    <Shield className="mx-auto text-white/10" size={80} />
                    <h2 className="text-3xl sm:text-6xl font-black italic leading-[1.1] tracking-tighter">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center space-y-8 sm:space-y-0 sm:space-x-12">
                        <div>
                            <p className="text-5xl font-black italic">4.2min</p>
                            <p className="text-white/50 text-[10px] font-black uppercase tracking-[0.2em] mt-3">Avg. Response</p>
                        </div>
                        <div className="w-px h-16 bg-white/10 hidden sm:block"></div>
                        <div>
                            <p className="text-5xl font-black italic">120k+</p>
                            <p className="text-white/50 text-[10px] font-black uppercase tracking-[0.2em] mt-3">Lives Impacted</p>
                        </div>
                        <div className="w-px h-16 bg-white/10 hidden sm:block"></div>
                        <div>
                            <p className="text-5xl font-black italic">100%</p>
                            <p className="text-white/50 text-[10px] font-black uppercase tracking-[0.2em] mt-3">Secure Handoff</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            {/* CTA Section */}
            <section className="py-24 px-6 sm:px-12 max-w-5xl mx-auto text-center space-y-12 relative z-10">
