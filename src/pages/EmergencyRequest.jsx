                        ...
                        {currentStep === 1 && (
                            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                ...
                                <div className="flex items-center justify-center space-x-8">
                                    ...
                                    >-</button>
                                    <span className="text-8xl font-bold text-slate-900 w-40 text-center tracking-tighter">{formData.units}</span>
                                    <button
                                    ...
                                    <div className="space-y-6">
                                        <div className="bg-slate-50 p-6 rounded-2xl space-y-4 border border-slate-100">
                                            <div className="flex justify-between items-center pb-4 border-b border-slate-200">
                                                ...
                                                <span className="text-xl font-bold text-slate-900">{formData.bloodType} Negative</span>
                                            </div>
                                            <div className="grid grid-cols-2 gap-4">
                                                <div className="flex-1">
                                                    <p className="text-xs text-slate-400 font-bold uppercase tracking-[0.2em] mb-1">Target Blood Specification</p>
                                                    <span className="text-2xl font-bold text-slate-900">{formData.bloodType} Negative</span>
                                                </div>
