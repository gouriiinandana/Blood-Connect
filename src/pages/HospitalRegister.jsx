                ...
                <div className="relative z-10">
                    <div className="mb-12">
                        <div className="flex items-center space-x-4 mb-4">
                            ...
                            <div>
                                <h2 className="text-3xl font-black text-slate-800 italic tracking-tight">Hospital Onboarding</h2>
                            ...
                            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="md:col-span-2">
                                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3 px-1">Facility Type</p>
                        ...
                        {currentStep === 2 && (
                            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
                                <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 space-y-1">
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Your Login ID (Registration Number)</p>
                                    <p className="text-xl font-black text-secondary italic">{form.registrationNo || 'N/A'}</p>
                                ...
                                <label className="flex items-start space-x-3 cursor-pointer p-4 bg-slate-50 rounded-2xl border border-slate-100 hover:bg-white transition-all select-none">
                                    ...
                                    <span className="text-[10px] text-slate-500 font-medium leading-relaxed uppercase tracking-wide">
                                        I confirm the provided details are accurate and accept the <span className="text-secondary font-black underline decoration-dashed">Healthcare Data Terms</span> and Blood Connect network protocols.
                                    </span>
                                </label>
                            </div>
                        )}
                    ...
                    <div className="mt-12 flex items-center justify-between">
                        <button
                            ...
                            className={`flex items-center text-sm font-black text-slate-400 hover:text-secondary transition-all uppercase tracking-widest ${currentStep === 0 ? 'opacity-0 pointer-events-none' : ''}`}
                        >
                        ...
                        <Button
                            ...
                            className="h-14 px-10 bg-secondary shadow-xl shadow-secondary/25 italic font-black"
                        >
                    ...
                    <div className="mt-8 pt-8 border-t border-slate-50 text-center">
                        ...
                        <Link to="/hospital/login" className="mt-1 inline-flex items-center text-sm font-black text-secondary hover:underline italic group">
