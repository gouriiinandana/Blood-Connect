    ...
    <Reveal delay={delay}>
        <div className={`${bg} ${border} border rounded-3xl p-7 hover:-translate-y-1 transition-transform`}>
            <div className="flex items-center space-x-3 mb-5">
                ...
                <h3 className={`font-bold text-slate-800 text-lg tracking-tight leading-tight`}>{title}</h3>
            </div>
                ...
                <div className="relative max-w-5xl mx-auto px-6 py-28 text-center">
                    <div className="transition-all duration-1000" style={{
                        ...
                        <div className="inline-flex items-center px-4 py-1.5 bg-white/10 backdrop-blur rounded-full text-[10px] font-bold uppercase tracking-[0.3em] mb-8 border border-white/20">
                            Medical Privacy Standard
                        </div>
                        <h1 className="text-5xl sm:text-7xl font-bold tracking-tight leading-none mb-8">
                            Health Data <br />Protection
                        </h1>
                        <span className="text-teal-300 text-3xl sm:text-5xl font-bold tracking-tight leading-none">& Privacy Compliance</span>
                        <p className="text-lg text-teal-100 max-w-2xl mx-auto font-medium leading-relaxed mt-6">
            ...
            <div ref={contentRef} className="max-w-5xl mx-auto px-6 py-20">
                ...
                <Reveal>
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center px-4 py-1.5 bg-teal-500/10 text-teal-700 rounded-full text-[10px] font-bold uppercase tracking-[0.3em] border border-teal-200 mb-6">
                            Verified Protocol
                        </div>
                        <h2 className="text-3xl sm:text-5xl font-bold text-slate-800 tracking-tight">
                ...
                <Reveal>
                    <div className="relative bg-gradient-to-br from-slate-900 via-teal-900 to-slate-800 rounded-[2.5rem] p-12 text-white text-center overflow-hidden">
                        ...
                        <div className="relative">
                            ...
                            <h2 className="text-5xl font-bold tracking-tight mb-6">Privacy Builds Trust</h2>
                            <p className="text-teal-50 max-w-lg mx-auto text-lg mb-4">
                                Our platform is built on transparency and non-negotiable security protocols.
                            </p>
                            <p className="text-teal-100 max-w-lg mx-auto font-medium">
                                Blood Connect provides a <span className="text-white font-bold">secure, clinical-grade</span> platform
                                for sensitive medical data coordination.
                            </p>
                            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 mt-10">
                                <Link to="/register">
                                    <button className="flex items-center space-x-3 bg-white text-teal-800 font-bold px-10 py-5 rounded-2xl hover:bg-teal-50 transition-all shadow-2xl hover:scale-105 text-sm uppercase tracking-[0.2em]">
                                        <Shield size={20} />
                                        <span>Security Specs</span>
                                    </button>
                                </Link>
                                <Link to="/safety-protocols">
                                    <button className="flex items-center space-x-3 bg-white/10 text-white border border-white/20 font-bold px-10 py-5 rounded-2xl hover:bg-white/20 transition-all text-sm uppercase tracking-[0.2em]">
                                        <ArrowRight size={20} />
