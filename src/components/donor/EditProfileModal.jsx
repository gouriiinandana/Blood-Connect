    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-slate-900/40 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="bg-white w-full max-w-xl rounded-[2.5rem] shadow-2xl border border-slate-100 overflow-hidden animate-in slide-in-from-bottom-8 duration-500">
                <div className="p-10 border-b border-slate-50 flex items-center justify-between bg-slate-50">
                    <div>
                        <h2 className="text-2xl font-bold text-slate-800 tracking-tight">Hero Profile</h2>
                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] mt-2">Update contact & coordination preferences</p>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-8">
                    <div className="flex flex-col items-center mb-4">
                        ...
                        <p className="text-[10px] font-bold text-slate-400 uppercase mt-4 tracking-widest">Update Identification Photo</p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-3">
                            <label className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] px-1">Primary Phone</label>
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] px-1">Registered City</label>
                            <div className="relative">
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] px-1">Zip / Pincode</label>
                            <input name="pincode" value={formData.pincode} onChange={handleChange} className="w-full px-4 py-4 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-secondary/20 transition-all font-medium text-slate-800" />
                        </div>
                        <div className="space-y-3">
                            <label className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] px-1">Alert Network Radius: {formData.radius}km</label>
